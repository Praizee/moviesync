  ...
  if (error) {
    return (
      <div className="text-center py-12">
        <h3 className="text-xl font-medium mb-2 text-destructive">Error Loading Bookmarks</h3>
  ...
  if (movies.length === 0 && shows.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground">Movies and TV shows you bookmark will appear here for easy access.</p>
      </div>
    )
  }
