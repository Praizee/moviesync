        ...
        <div className="relative overflow-hidden rounded-xl bg-muted">
          <div className="aspect-[21/9] md:aspect-[3/1] flex items-center justify-center">
            <div className="p-6 md:p-12 text-center">
              <h1 className="text-2xl md:text-4xl font-bold mb-2 md:mb-4">Welcome to MovieSync</h1>
      ...
      <div className="relative overflow-hidden rounded-xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-center p-6 md:p-12">
          <div className="max-w-xl">
            <h1 className="text-2xl md:text-4xl font-bold text-white mb-2 md:mb-4">{featuredMovie.title}</h1>
            ...
            <p className="text-sm md:text-base text-white/80 line-clamp-3 mb-4 md:mb-6">{featuredMovie.overview}</p>
            <Button asChild size="lg">
