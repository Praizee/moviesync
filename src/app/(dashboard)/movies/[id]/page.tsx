  ...
  try {
              ...
              fallback={
                <div className="p-4 border border-amber-200 bg-amber-50 dark:bg-amber-950 dark:border-amber-900 rounded-lg mb-6">
                  <p className="text-amber-800 dark:text-amber-200">
                    <span className="font-semibold">Sign in required.</span> Please log in to view full movie details
                    and trailer.
                  </p>
                </div>
              }
    ...
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-2xl font-bold mb-4">Unable to load movie details</h1>
        <p className="text-muted-foreground mb-8">
          We're having trouble loading this movie's information. This could be due to a temporary issue.
        </p>
        <Button asChild>
